...
Please see [releases](https://github.com/nohana/buford/releases) for updates.

[![GoDoc](https://godoc.org/github.com/nohana/buford?status.svg)](https://godoc.org/github.com/nohana/buford) [![Build Status](https://travis-ci.org/RobotsAndPencils/buford.svg?branch=ci)](https://travis-ci.org/RobotsAndPencils/buford) ![MIT](https://img.shields.io/badge/license-MIT-blue.svg) [![codecov](https://codecov.io/gh/RobotsAndPencils/buford/branch/master/graph/badge.svg)](https://codecov.io/gh/RobotsAndPencils/buford)
...
[API documentation](https://godoc.org/github.com/nohana/buford/) is available from GoDoc.
...
```
go get -u -d github.com/nohana/buford
```
...
import (
	...
	"github.com/nohana/buford/certificate"
